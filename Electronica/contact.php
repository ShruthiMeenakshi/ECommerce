            ...
            <div class="bg-white rounded-xl shadow-2xl overflow-hidden w-full max-w-md animate__animated animate__fadeInUp">
                ...
                <div class="px-8 py-10 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-3">
                        <a href="index.html" class="flex-1 flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg shadow hover:shadow-md transition-all hover:scale-[1.02]">
                    ...
                    <div class="mt-8 text-sm text-gray-400">
                        <p>Reference ID: #EM-${rand(10000, 99999)}</p>
                    </div>
                </div>
